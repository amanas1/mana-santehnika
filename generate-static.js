...
seoData.services.forEach(service => {
  ...
  const description = `${service.title} в Алматы — выезд за 30 минут 24/7. ${service.description} Гарантия 12 месяцев. Честные цены. ☎ +7 (705) 553-53-32`;
...
const staticPages = [
  {
    ...
    description: 'Полный каталог сантехнических услуг в Алматы: вызов мастера, ремонт труб, установка смесителей, замена бойлера, ремонт унитаза и душевых кабин. Выезд 24/7.',
  ...
  },
  {
    ...
    description: 'Контакты профессионального сантехника в Алматы. Телефон: +7 (705) 553-53-32. WhatsApp. Принимаем вызовы круглосуточно, выезд за 30 минут.',
