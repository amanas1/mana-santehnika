        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <article className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
            ...
            <div className="p-8 md:p-12 lg:px-16 prose prose-lg md:prose-xl max-w-none text-gray-700 font-medium leading-relaxed">
              ...
              <p>
                Если после замены картриджа проблема не исчезла или вы чувствуете, что работа требует профессионального подхода — я всегда рядом. В Алматы я выезжаю на дом в удобное время со всем необходимым инструментом.
              </p>
            </div>
