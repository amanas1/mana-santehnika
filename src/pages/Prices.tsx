...
const priceCategories: PriceCategory[] = [
  {
    ...
    icon: Droplets,
    items: [
      { name: "Прочистка кухни от засора", unit: "за услугу", price: "от 5 000 ₸", popular: true },
      { name: "Прочистка кухонной мойки", unit: "за услугу", price: "от 5 000 ₸", popular: true },
      { name: "Чистка сифона на кухне", unit: "за услугу", price: "от 4 000 ₸" },
      { name: "Устранение засора под раковиной", unit: "за услугу", price: "от 5 000 ₸" },
      { name: "Замена сифона на кухне", unit: "за шт.", price: "от 4 000 ₸" },
      { name: "Проверка слива кухонной мойки", unit: "за услугу", price: "от 3 500 ₸" },
    ],
  },
  {
    id: "water",
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Срочная прочистка кухни", unit: "за услугу", price: "от 6 000 ₸" },
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col pt-16 md:pt-20">
      <SEO 
        ...
        description="Актуальный прайс-лист на все виды сантехнических услуг в Алматы. Прозрачные цены без скрытых платежей. Выезд и диагностика входят в стоимость."
        ...
        <div className="container mx-auto">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="bg-white rounded-2xl p-6 mb-10 shadow-lg border border-gray-100 flex items-center gap-6">
              ...
              <div>
                <h3 className="text-xl font-bold text-gray-900 mb-1">Выезд и диагностика входят в стоимость*</h3>
                <p className="text-gray-500 text-sm">*При согласии на проведение ремонтных работ. В случае отказа от ремонта оплачивается вызов мастера в размере 5000 тенге.</p>
              </div>
            </div>
