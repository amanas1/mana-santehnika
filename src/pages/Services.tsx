  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      <SEO 
        ...
        description="Услуги сантехника в Алматы: вызов мастера, устранение протечек, ремонт бойлера, установка смесителей, подключение стиральных машин. Цены от 3 500 ₸. Ежедневно с 9:00 до 21:00."
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mt-20 max-w-4xl mx-auto bg-gradient-to-br from-[#0095DA] to-[#0070a3] rounded-3xl p-8 md:p-12 text-center text-white shadow-2xl relative overflow-hidden">
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto relative z-10">
              Напишите в WhatsApp или позвоните. Обсудим вашу задачу и согласуем удобное время визита.
            </p>
