  ...
  const reviews = [
    {
      ...
      text: "Очень благодарна Манасу за быструю работу. Смеситель на кухне потек в выходной день. Мастер приехал вовремя, сам купил нужные запчасти. Все сделал аккуратно и дал гарантию. Рекомендую!",
      rating: 5
    },
    {
      name: "Тимур",
