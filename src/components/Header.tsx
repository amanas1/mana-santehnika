...
const LogoSVG = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1700 400" className={className}>
    ...
    <text x="440" y="190" fontFamily="'Inter', 'Montserrat', 'Arial Black', sans-serif" fontWeight="900" fontSize="120" fill="currentColor" textAnchor="start" letterSpacing="0">Сантехник</text>
